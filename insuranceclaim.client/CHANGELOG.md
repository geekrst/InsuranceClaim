...
- Create Angular project with ng: `ng new insuranceclaim.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`insuranceclaim.client.esproj`).
